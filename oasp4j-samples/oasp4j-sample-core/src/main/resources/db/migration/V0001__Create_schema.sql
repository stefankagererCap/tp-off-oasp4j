...
ALTER TABLE PUBLIC.SPECIAL ADD CONSTRAINT PUBLIC.PK_SPECIAL PRIMARY KEY(id);
...
ALTER TABLE PUBLIC.SPECIAL ADD CONSTRAINT PUBLIC.FK_SPECIAL2OFFER FOREIGN KEY(offer_id) REFERENCES PUBLIC.OFFER(id) NOCHECK;
